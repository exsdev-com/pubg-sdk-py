"""Synchronous and asynchronous clients for PUBG API."""
import json
import logging
...
@dataclass
class ClientOptions:
    """Options to configure the pubg_client.
    Attributes:
        ...
        notion_version: PUBG API version to use.
    """
...
class Client(BaseClient):
    """Synchronous pubg_client for PUBG API."""
    ...
    def close(self) -> None:
        """Close the connection pool of the current inner pubg_client."""
        self.client.close()
...
class AsyncClient(BaseClient):
    """Asynchronous pubg_client for PUBG API."""
